...
@TeleOp(name = "PixelTest")

public class PixelTracking extends LinearOpMode {
    ...
    public static final double focalLength = 810;
    ...
    private static double getDistance(double width) {
        ...
        return distance;// end method telemetryTfod()
    }
